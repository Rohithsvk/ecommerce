...
<body>
<div style="color: Black; text-align: center; font-size: 30px;">Orders Received <i class="fas fa-archive"></i></div> <br>
<% 
...
<table  cellpadding="15" cellspacing="5" border="5" id="customers">
        ...
        try{
        	...
        	ResultSet rs= st.executeQuery(" select * from cart inner join eproduct where cart.product_id=eproduct.product_id and cart.orderDate is not null and cart.status='processing'");
        	while(rs.next())
        	{
        		sno=sno+1;
        %>
